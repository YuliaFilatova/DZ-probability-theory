...
#b)
p=q1*p2*q3
print("3.b вторым спортсменом",p)
#c)
p=q1*q2*p3
print("3.c третим спортсменом",p)
...
print("4. доля сдавших студентов от общего количества поступивших",pt)
...
p23=q1*p2*p3
pt2=p12+p13+p23
print("5.б Вероятность выхода из строя 2-х деталей",pt2)

#c
#ищем вероятность, что не выйдет ни одна деталь
pn=q1*q2*q3
p=1-pn
print("5.в Вероятность выхода хотябы 1-й детали",p)
